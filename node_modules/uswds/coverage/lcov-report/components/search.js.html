...
<html lang="en">
<head>
    <title>Code coverage report for components/search.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">components/</a> search.js
    </h1>
    <div class='clearfix'>
...
var clickEvent = ('ontouchstart' in document.documentElement)
  ? <span class="branch-0 cbranch-no" title="branch not covered" >'touchstart'</span>
  : 'click';
&nbsp;
var searchForm;
var searchButton;
...
function searchButtonClickHandler (event) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (searchForm.hidden) {
<span class="cstat-no" title="statement not covered" >    closeSearch();</span>
  } else {
    openSearch();
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (searchButton &amp;&amp; searchForm) {
    closeSearch();
...
&nbsp;
function searchOff () {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (activateDispatcher) {
