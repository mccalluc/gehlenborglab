...
<html lang="en">
<head>
    <title>Code coverage report for components/validator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">components/</a> validator.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
function getData (el) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!el.hasAttributes()) <span class="cstat-no" title="statement not covered" >return;</span>
  var data = {};
